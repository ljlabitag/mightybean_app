...
export default function Home() {
  ...
  <main className='flex flex-row h-auto' style={bgImage}>
    <div className='basis-3/5 content-center p-24'></div>
    
    <div className='basis-2/5 p-16'>
    <div class="relative flex flex-col text-gray-700 bg-white shadow-md w-96 rounded-xl bg-clip-border">
      
      <div class="relative grid mx-4 mb-4 -mt-6 pl-6 overflow-hidden text-white shadow-lg h-16 justify-items-start items-center rounded-xl bg-gradient-to-tr from-gray-900 to-gray-800 bg-clip-border shadow-gray-900/20">
      ...
      <div class="p-6 pt-0">
        ...
        <button type="button" class="w-full mt-6 justify-center select-none rounded-lg bg-gradient-to-tr from-gray-900 to-gray-800 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
        Sign in with Google
        </button>
      </div>
    </div>
